...
{
    [CustomEditor(typeof(TriggerInteractor))]
    internal class DirectInteractorEditor : Editor
    {
        ...
        {
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Script", MonoScript.FromMonoBehaviour((TriggerInteractor)target), typeof(TriggerInteractor), false);
            GUI.enabled = true;
