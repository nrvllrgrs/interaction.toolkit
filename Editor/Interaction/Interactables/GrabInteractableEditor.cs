...
namespace UnityEditor.Interaction.Toolkit
{
    ...
    internal class GrabInteractableEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUI.enabled = false;
            EditorGUILayout.ObjectField("Script", MonoScript.FromMonoBehaviour((GrabInteractable)target), typeof(GrabInteractable), false);
            GUI.enabled = true;
