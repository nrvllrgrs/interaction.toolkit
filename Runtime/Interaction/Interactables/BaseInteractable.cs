...
namespace UnityEngine.Interaction.Toolkit
{
    ...
    public abstract class BaseInteractable : MonoBehaviour
    {
		...
		protected internal virtual void OnSelectEnter(BaseInteractor interactor) 
		{
			isSelected = true;
		...
		protected internal virtual void OnSelectExit(BaseInteractor interactor) 
		{
			isSelected = false;
		...
		protected internal virtual void OnActivate(BaseInteractor interactor)
        {
            m_OnActivate?.Invoke(interactor);
        }

        protected internal virtual void OnDeactivate(BaseInteractor interactor)
        {
